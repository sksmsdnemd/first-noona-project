...
Alim_view.prototype.make_pop = function(){	
	var html = "";
		...
		}else if( this.winSize == "small2" ){
			html += '<div class="pop_alim small2">'
		}else{
		...
		html +=                 '<a href="#" class="btn_showHide">세부사항</a>'
		}
        html +=             '</div>'
		if( this.state == "extend" ){
...
/* 경고창 - STTPlayC player 에서 사용할 alert
 * 
 */
function argoSmall2Alert(dist, sMessage, sExtMsg, sConfirm){
