...
Page_preview.prototype.make_window = function(){
 ...
 //   html +=         '<div class="pop_title print_hd">' + this.title + ' 미리보기<a href="#" class="btn_excel" title="엑셀 다운로드">엑셀 다운로드</a><a href="#" class="btn_print" title="인쇄">인쇄</a><a href="#" class="btn_popClose">닫기</a></div>'
    html += '<div class="pop_title print_hd">' + this.title + '<a href="#" class="btn_print" title="인쇄">인쇄</a><a href="#" class="btn_popClose">닫기</a></div>'
	...
	var pagePreview = $("body").pagePreview({
		...
		onPrint:function(){
			...
			if(sSelector != null && sSelector != undefined) {
				...
				if(_url =="../EDU/EDU1020S02F.do" && sTitle !='문항관리') { // 시험지 미리보기 인 경우 여러 화면에서 공통으로 호출되므로 인쇄 타이틀 부분 여기서 처리함
						sTitle = '<div class="print_title">'+ sTitle+ '</div>' 
				   		               + '<div class="print_title_sub"><div style="float:right;">'
				  		               + '<span style="padding-right:180px;">행번 :</span>'
				  		               + '<span style="padding-right:100px;">이름 :</span>'    
				  		             + '</div></div><br>';						
					...
					sTitle = '<div class="print_title">'+ sTitle+ '</div>'
						   ...
						   + '<thead><tr class="txt_c"><th>평가구분</th><th>소속</th><th>행번</th><th>상담사명</th></tr></thead>'
						   + '<tbody><tr><td>평가자</td><td></td><td></td><td></td></tr><tr><td>평가대상자</td><td></td><td></td><td></td></tr></tbody>'
						   + '</table></div>';			
