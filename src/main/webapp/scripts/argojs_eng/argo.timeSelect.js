		...
		if( time_val != "" ){
			...
			if(thisObj.use_sec){
				if( time_val.length == 3 ){
					...
					if(inputHour > 23){
						argoAlert("When entering a hour, You should enter a(n) <br> number ranging from 00 to 23.");
						thisObj.outputTime2();
					}
					else if(inputMin > 59){
						argoAlert("When entering a minute, You should enter a(n) <br> number ranging from 00 to 59.");
						thisObj.outputTime2();
					}
					else if(inputSec > 59){
						argoAlert("초는 00부터 59까지의<br>숫자를 입력해야 합니다When entering a second, You should enter a(n) <br> number ranging from 00 to 59.");
						thisObj.outputTime2();
					} else {
