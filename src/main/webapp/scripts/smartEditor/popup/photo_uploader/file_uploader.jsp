			...
			if(item.getSize() > 0) {
				...
				filename_ext = filename_ext.toLowerCase();
			   	...
			   	if(cnt == 0) {
		    		...
		    		//파일 기본경로 _ 상세경로
		     		String filePath = dftFilePath + Globals.UPLOAD_PATH()  +"editor/upload/" ;
		    		File file = null;
		    		...
		    		//return3 += "&sFileURL=../.."+Globals.UPLOAD_PATH()  +"editor/upload/" + realFileNm;
		    		return3 += "&sFileURL="+sURL+Globals.UPLOAD_PATH()  +"editor/upload/" + realFileNm;
			   	}
			}else {
