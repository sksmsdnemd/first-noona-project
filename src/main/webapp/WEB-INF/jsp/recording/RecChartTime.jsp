...
<script>
	...
	var workMenu  	= "시간별통계";
	var workLog		= "";
	var colorArray 	= ["#FF3300", "#FF4400", "#FF5500", "#FF6600", "#FF9E01", "#FCD202", "#F8FF01", "#B0DE09",
	                   "#FF0F00", "#0D8ECF", "#0D52D1", "#2A0CD0", "#8A0CCF", "#8A0D74", "#8A4DEB", "#8ADDDD",
	                   "#8A0CCF", "#CD0D74", "#754DEB", "#DDDDDD", "#999999", "#666666", "#333333", "#000000"
					];
	...
	function fnInitCtrl(){		
		...
		$("#btnExcel").click(function(){
			...
			argoJsonSearchList('recSearch', 'getRecChartTimeList', 's_', {userId:userId, controlAuth:controlAuth, grantId:grantId}, function (data, textStatus, jqXHR){
				try {
					if (data.isOk()) {
	...
	function fnInitGrid(){
		...
		$('#gridList').w2grid({ 
	        ...
	        columns: [  
		            	 { field: 'recTime', 	caption: '통화시간대', 	size: '80px',  sortable: true, attr: 'align=center' }
			           	,{ field: 'callCnt', 	caption: '통화수', 	size: '80px',  sortable: true, attr: 'align=center' }
			           	,{ field: 'callTime', 	caption: '총통화시간', 	size: '100px', sortable: true, attr: 'align=center' }
	        ],
	        records: dataArray
	    });	 
	}
						...
						var char = AmCharts.makeChart("div_Chart",
							{
								...
								"fontSize": 12,
								"colors": [
									"#5571c6", "#db9d61", "#55c6c2", "#0D8ECF", "#2A0CD0", "#CD0D74", "#CC0000", "#00CC00",	"#0000CC", "#DDDDDD", "#999999", "#DDDDDD",
									"#999999",
									"#333333",
									"#990000"
								],
...
<body>
	<div class="sub_wrap">
        <div class="location">
        	<span class="location_home">HOME</span><span class="step">통화내역관리</span><span class="step">통화내역집계</span><strong class="step">시간별 통계</strong>
        </div>
	            ...
	            <div>
	            	<ul class="search_terms">
	            		<li style="width:315px">
	            			<div id="gridList" style="height:410px;"></div>
	            		</li>
	            		<li style="width:10px">&nbsp;</li>
	            		<li style="width:775px">	
	            			<div class="cont_box">
