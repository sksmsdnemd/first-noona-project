...
<body>
<%
	String reqMfuIp = request.getParameter("mfuIp");
	String reqMfuPort = request.getParameter("mfuPort");
	String reqDnNo = request.getParameter("dnNo");
	String reqUserId = request.getParameter("userId");
	String reqCallId = request.getParameter("callId") == null ? "" : request.getParameter("callId");
	...
	String videoSrc = protocol + reqMfuIp + ":" + reqMfuPort + "/filescr/" + reqDnNo + "/" + reqUserId + "/" + reqCallId + "/" + strEncKey + "/" + reqDnNo + ".mp4";
%>
	<div class="container">
