...
function fnInitGrid(){
	...
	var columns = [ { name: "eduKindNm"
				  ...
				  , { name: "eduStatusNm"
					, fieldName: "eduStatusNm"	
					, header : { text: "진행상태" }
					, width: 50
					, styles  : { textAlignment : "center" }
					, dynamicStyles: [
						{criteria: "value like '%준비중%'",styles: "foreground=#9d9d9d"},
						{criteria: "value like '%진행%'",styles: "foreground=#008000"},
						{criteria: "value like '%완료%'",styles: "foreground=#2080D0"},
						{criteria: "value like '%취소%'",styles: "foreground=#BF6000"}
					]
					}
   	       		  ];
...
function fnSearchList(){
	argoGrSearch("dataProvider1", "ARGOCOMMON", "SP_UC_GET_EDU_SCHE", "s_", ''); 
}
