...
var fvUserNm = "";
	...
	$(function () {		
		...
		sPopupOptions.get = function(key, value) {
	     ...
	     $("#btnSearch_UserChoice04").click(function(){
	    	 fnSearchList_UserChoice03();
	     })
	     
	     $("#btnConfirm_UserChoice04").click(function(){			
			argoConfirm("등록하시겠습니까?", function() {
				fnSetUserChoice();
				//argoPopupClose();
			 });
		 });
		...
		$('#grList_UserChoice03_1').w2grid({ 
	        ...
	        onDblClick: function(event) {
	        	if( fvMultiYn!='Y') {
    	    		...
    	    		$("#btnConfirm_UserChoice04").trigger('click');
    	    	}
	        },
	        columns: [
	...
	function fnSetUserChoice() {
        ...
        //argoAlert("warning", "등록되었습니다.", "", "argoPopupClose();");
        
        argoAlert("warning", "등록되었습니다.", "", function() {
        	argoPopupClose();
		});
...
<body>
        ...
        <section class="pop_contents">
            <div class="btn_topArea">
                ...
                <span class="btn_r">
                      <button type="button" id="btnSearch_UserChoice04" name="btnSearch_UserChoice04" class="btn_m search" >조회</button>  
                </span>
            </div>    
            <div class="pop_cont">            
                ...
                <div class="btn_areaB txt_r">
                    <a href="#" class="btn_m confirm" id="btnConfirm_UserChoice04">등록</a>   
            	</div>
            </div>            
        </section>
    </div>
