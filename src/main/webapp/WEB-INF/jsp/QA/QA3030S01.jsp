...
var sRecTableNm = "";
	...
	function fnConfirmMod(){
		argoJsonCallSP('QA', 'SP_QA3030S01_01', '__', {sheetkey : sPopupOptions.sheetkey}, function(data, textStatus, jqXHR) {
			if (data.isOk()) {
			}
		})
	}
	...
	function fnSearchList(){
		try {
			var param = {sheetkey : sPopupOptions.sheetkey};
	...
	function fnSave(qaValueStatus) {
		...
		if(qaValueStatus == '20'){ //완료버튼 클릭시
			msg = "상담사 통화품질평가를 완료 하시겠습니까?";
		}else{
			msg = "상담사 통화품질평가를 저장 하시겠습니까?";
		}
